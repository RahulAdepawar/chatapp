...
export default function ContactList() {
	...
	const [selectedContact, setSelectedContact] = useState<ContactList | null>(null);
	...
	const handleClickContact = (contact: ContactList | null) => {
		...
		<div className="h-full flex flex-col">
			...
			{selectedContact ? (
				<div className="flex flex-col h-full w-full">
					{/* Header / Back */}
					<div className="flex items-center gap-3 p-4 border-b border-gray-200 dark:border-neutral-700">
						<button onClick={() => handleClickContact(null)}>
							<TiArrowBack size={22} />
						</button>
